...
import 'package:riverpodfuckaround/core/helpers/app_overlays_helper.dart';
      ...
      body: switch (viewState) {
        AsyncData(:final value) => Column(
          children: [
            ...
            Divider(),
            value.someOtherData.when(
              successBuilder: (String? data) {
                return Column(
                  children: [
            ...
            TextButton(
              onPressed: () {
               AppOverlaysHelper().showAppDialog((context) => AboutDialog());
              },
              child: Text("Test2"),
            ),
          ],
